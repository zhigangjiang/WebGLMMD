...
/***/ function(module, exports, __webpack_require__) {
	...
	//**modify
	var DEFAULT_DEFAULT_PRESET_NAME = '默认';
	      ...
	      set: function set(v) {
	        ...
	        if (_this.__closeButton) {
	        	...
	        	try{
	        		...
	        		console.log("未定义calledClosGui()函数");
	        	}
	...
	//**modify
	GUI.DEFAULT_WIDTH = 270;
	
	GUI.TEXT_CLOSED = '关闭设置';
	GUI.TEXT_OPEN = '打开设置';
...
/***/ function(module, exports) {
	//**modify
	module.exports = "<div id=\"dg-save\" class=\"dg dialogue\">\n\n  这里生成了新的GUI控制器参数：\n\n  <textarea id=\"dg-new-constructor\"></textarea>\n\n  <div id=\"dg-save-locally\">\n\n    <input id=\"dg-local-storage\" type=\"checkbox\"/> 退出时，自动保存参数值到本地存储。\n\n    <div id=\"dg-local-explain\">保存到本地存储的参数值将在下次打开时自动加载。 </div>\n\n  </div>\n\n</div>";
